...
def write_results(file_path, model, history, train_gen, val_gen):
    result_dict = {}
...
#     print('Number of Extra Layers: ', len(results['layers']))
#     for layer in results['layers']:
#         print(' Type: {}\n Units: {}\n Activation: {}\n ---------------'.format(layer['layer_type'], layer['units'], layer['activation']))
